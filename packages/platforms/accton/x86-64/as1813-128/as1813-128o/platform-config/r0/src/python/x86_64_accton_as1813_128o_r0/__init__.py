...
class OnlPlatform_x86_64_accton_as1813_128o_r0(OnlPlatformAccton,
                                              OnlPlatformPortConfig_128x800_2x25):
    PLATFORM='x86-64-accton-as1813-128o-r0'
    MODEL="AS1813-128O"
    SYS_OBJECT_ID=".1813.128"
