...
struct as1813_128o_sys_data *data = NULL;

static struct platform_driver as1813_128o_sys_driver = {
    .probe      = as1813_128o_sys_probe,
    .remove     = as1813_128o_sys_remove,
    .driver     = {
        .name   = DRVNAME,
        .owner  = THIS_MODULE,
    },
...
static const struct attribute_group as1813_128o_sys_group = {
    .attrs = as1813_128o_sys_attributes,
};
...
static int as1813_128o_sys_remove(struct platform_device *pdev)
{
    ...
    sysfs_remove_group(&pdev->dev.kobj, &as1813_128o_sys_group);

    return 0;
}

static int __init as1813_128o_sys_init(void)
{
    int ret;

    data = kzalloc(sizeof(struct as1813_128o_sys_data), GFP_KERNEL);
    if (!data) {
        ret = -ENOMEM;
        goto alloc_err;
    }
...
MODULE_DESCRIPTION("as1813_128o_sys driver");
MODULE_LICENSE("GPL");

module_init(as1813_128o_sys_init);
module_exit(as1813_128o_sys_exit);
