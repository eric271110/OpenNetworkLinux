...
static ssize_t show_string(struct device *dev, struct device_attribute *attr,
                            char *buf);
static int as1813_128o_psu_probe(struct platform_device *pdev);
static int as1813_128o_psu_remove(struct platform_device *pdev);
...
struct as1813_128o_psu_data *data = NULL;

static struct platform_driver as1813_128o_psu_driver = {
    .probe = as1813_128o_psu_probe,
    .remove = as1813_128o_psu_remove,
    .driver = {
        .name = DRVNAME,
        .owner = THIS_MODULE,
    },
...
enum as1813_128o_psu_sysfs_attrs {
    /* psu attributes */
    PSU_ATTR(1),
    PSU_ATTR(2),
    PSU_ATTR(3),
...
static struct attribute *as1813_128o_psu1_attrs[] = {
    /* psu attributes */
    DECLARE_PSU_ATTR(1),
...
static struct attribute_group as1813_128o_psu1_group = {
    .attrs = as1813_128o_psu1_attrs,
};
/* ATTRIBUTE_GROUPS(as1813_128o_psu1); */
...
static struct attribute *as1813_128o_psu2_attrs[] = {
    /* psu attributes */
    DECLARE_PSU_ATTR(2),
...
static struct attribute_group as1813_128o_psu2_group = {
    .attrs = as1813_128o_psu2_attrs,
};
...
static struct attribute *as1813_128o_psu3_attrs[] = {
    /* psu attributes */
    DECLARE_PSU_ATTR(3),
...
static struct attribute_group as1813_128o_psu3_group = {
    .attrs = as1813_128o_psu3_attrs,
};
...
static struct attribute *as1813_128o_psu4_attrs[] = {
    /* psu attributes */
    DECLARE_PSU_ATTR(4),
...
static struct attribute_group as1813_128o_psu4_group = {
    .attrs = as1813_128o_psu4_attrs,
};

const struct attribute_group *as1813_128o_psu_groups[][2] = {
    {&as1813_128o_psu1_group, NULL},
    {&as1813_128o_psu2_group, NULL},
    {&as1813_128o_psu3_group, NULL},
    {&as1813_128o_psu4_group, NULL}
};
...
static struct as1813_128o_psu_data *as1813_128o_psu_update_device(struct device_attribute *da)
{
...
static int __init as1813_128o_psu_init(void)
{
    int ret;
    int i;

    data = kzalloc(sizeof(struct as1813_128o_psu_data), GFP_KERNEL);
    if (!data) {
        ret = -ENOMEM;
        goto alloc_err;
    }
...
static void __exit as1813_128o_psu_exit(void)
{
    int i;
...
MODULE_DESCRIPTION("as1813_128o_psu driver");
MODULE_LICENSE("GPL");

module_init(as1813_128o_psu_init);
module_exit(as1813_128o_psu_exit);
